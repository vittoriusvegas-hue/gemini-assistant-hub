...
import { Bot, Inbox, Users, Settings, BarChart3, Sparkles, Trello, LogOut, ShieldCheck, Shield, Boxes, Briefcase } from "lucide-react";
...
const items: { to: string; label: string; icon: typeof Inbox; feature: FeatureKey }[] = [
  ...
  { to: "/inventory", label: "Inventario", icon: Boxes, feature: "inventory" },
